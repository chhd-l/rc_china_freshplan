export const formulaData: FormulaData[] = [
  {
    ...
    Ingredientlist: ['粗蛋白质 — 8% 以上', '粗脂肪 — 4% 以上', '粗纤维 — 最大 2%', '水分 — 最大 75%'],
    crudeProtein: '55',
    crudeFat: '93',
    image: 'niurou.png',
  ...
  },
  {
    ...
    Ingredientlist: ['粗蛋白质 — 8. 5% 以上', '粗脂肪 — 6% 以上', '粗纤维 — 最大 1%', '水分 — 最大 77%'],
    crudeProtein: '54',
    crudeFat: '88',
    image: 'jirou.png',
  ...
  },
  {
    ...
    calorie: '1479大卡/公斤，201大卡/杯ME',
    Ingredientlist: ['粗蛋白质 — 10% 以上', '粗脂肪 — 5分钟', '粗纤维 — 最大 1%', '水分 — 最大 72%'],
    crudeProtein: '46',
    crudeFat: '91',
    image: 'huoji.png',
